...
<h2 class="navbar-brand f" href="#" style="color:black;" ><?php echo e($shop->name); ?></h2>
...
<!--/.Navbar-->
  <!-- nab bar =================-->
    <section>
      <div class="container">
        <!---King & Queen -->
    <?php $__currentLoopData = $shop_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="row">
               ...
               <div class="card shop" style="margin-top:20px;">
                    <div class="amount">
                            <?php echo e($s->price); ?> Kyats
                        </div>
                  <img class="card-img-top im" src="../images/<?php echo e($s->photoURL); ?>" alt="Card image cap" >
                  <div class="card-footer">
                      <h5 class="description"> <?php echo e($s->name); ?></h4>
                  </div>
                </div>
              </div>
         </div>
