      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav nav-flex-icons">
                ...
                <li class="nav-item">
                        <a class="nav-link waves-effect" href="#" ><i class="fa fa-user fa-fw"></i><?php echo e(Auth::user()->name); ?></a>
                </li>
                <li class="nav-item">
      ...
      <div class="list-group list-group-flush">
          ...
          <a href="shop" class="list-group-item list-group-item-action waves-effect">
            ...
            <a href="participant" class="list-group-item list-group-item-action  waves-effect">
                    ...
                    <a href="showparticipant" class="list-group-item list-group-item-action active waves-effect">
