                      ...
                      <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"  style="background-color : white;margin-top:32px;">
                              ...
                              <div class="col-lg-12" style="margin: 16px 8px 16px 4px" >
                                          <?php echo Form::open(['method'=>'POST','action'=>'QuizController@store','files'=>true]); ?>
                                                  ...
                                                  <div class="input-group mb-3">
                                                       ...
                                                       <div class="input-group mb-3">
                                                           ...
                                                           <?php echo Form::text('item1',null,['class'=>'form-control','placeholder' => 'Item1']); ?>
                                                         ...
                                                         <div class="input-group mb-3">
                                                               ...
                                                               <?php echo Form::text('item2',null,['class'=>'form-control','placeholder' => 'item2']); ?>
                                                             ...
                                                             <div class="input-group mb-3">
                                                                   ...
                                                                   <?php echo Form::text('item3',null,['class'=>'form-control','placeholder' => 'item3']); ?>
                                                                 ...
                                                                 <div class="input-group mb-3">
                                                                       ...
                                                                       <?php echo Form::text('item4',null,['class'=>'form-control','placeholder' => 'item4']); ?>
                                                                 ...
                                                                 <div class="input-group mb-3">
                                                                       ...
                                                                       <?php echo Form::text('answer',null,['class'=>'form-control','placeholder' => 'Answer']); ?>
...
<?php echo $__env->make('layouts.Admin.quiz', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>