        ...
        <div class="card">
          ...
          <div class="card-body">
                ...
                <div class="col-lg-12" style="margin: 32px 8px 16px 4px">
                        <?php echo Form::model($shop_item,['method'=>'POST','action'=>['ShopitemController@update',$shop_item->id],'files'=>true]); ?>
                        ...
                        <?php echo Form::hidden('_method', 'PATCH'); ?>
                                          ...
                                          <div class="input-group mb-3">
                                                 ...
                                                 <?php echo Form::text('name',$shop_item->name,['class'=>'form-control','placeholder' => 'Name']); ?>
                                                ...
                                                <div class="input-group mb-3">
                                                 ...
                                                 <div class="input-group mb-3">
                                                       ...
                                                       <?php echo Form::text('price',$shop_item->price,['class'=>'form-control','placeholder' => 'price']); ?>
