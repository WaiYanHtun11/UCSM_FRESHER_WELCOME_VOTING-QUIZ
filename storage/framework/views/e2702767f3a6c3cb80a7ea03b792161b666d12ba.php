...
<a href="Homeshopitem\<?php echo e($s->id); ?>">
        <div class="row">

            <div class="col-sm-12">
           <div class="card shop">
              <img class="card-img-top sho" src="images/shop1.jpg" alt="Card image cap" >
              <div class="card-footer">
                  <h5 class="description" style="color:black !important;"> <?php echo e($s->name); ?></h4>
              </div>
            </div>
          </div>
     </div>
