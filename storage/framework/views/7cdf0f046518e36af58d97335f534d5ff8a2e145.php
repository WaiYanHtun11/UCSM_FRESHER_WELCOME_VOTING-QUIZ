                      ...
                      <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab"  style="background-color : white;margin-top:32px;">
                                    ...
                                    <div class="col-lg-12" style="margin: 16px 8px 16px 4px" >
                                            <?php echo e(Form::open(array('action' => 'ParticipantController@store', 'files' => true,'method' => 'POST'))); ?>
                                            ...
                                            <div class="input-group mb-3">
                                                 ...
                                                 <div class="input-group mb-3">
                                                       ...
                                                       <?php echo Form::select('shop',$sh, null, ['placeholder' => 'Select Catagory Name ...','class'=>'form-control']);; ?>
                                ...
                                <?php echo Form::close(); ?>
                                  ...
                                  <div class="tab-pane fade show " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"  style="background-color : white;margin-top:32px;">
                                        ...
                                        <div class="col-lg-12" style="margin: 16px 8px 16px 4px" >
                                                <?php echo e(Form::open(array('action' => 'parti_cataController@store', 'files' => true,'method' => 'POST'))); ?>
...
<?php $__currentLoopData = $cata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>



                                              <tbody>
                                                    <tr>
                                                            <th scope="row"><?php echo e($ca-> id); ?></th>
                                                            <td> <?php
                                                            $name = $ca->name;
                                                    ...
                                                    <td>
                                                            <a class="btn btn-warning waves-effect btn-small" href="parti_cata/<?php echo e($ca->id); ?>/edit" style="padding: 8px 12px 8px 12px;margin-top: -10px">Edit</a>
                                                          <a class="btn btn-danger waves-effect btn-small" href="parti_cata/<?php echo e($ca->id); ?>/delete" style="padding: 8px 12px 8px 12px;margin-top: -10px"><i class="fas fa-times-circle"></i></a>
                                                          </td>
                                                </tr>
                                                  </tbody>
...
<?php echo $__env->make('layouts.Admin.participant', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>