...
<h2 class="navbar-brand f" href="#" style="color:black;" ><?php echo e($cata); ?></h2>
...
<a href="../Homeviews/<?php echo e($p->id); ?>/<?php echo e($cata); ?>/1" style="color : black;">
        <div class="row">

            <div class="col-sm-12">
           <div class="card shop">
              <img class="card-img-top m" src="../images/<?php echo e($p->photoURL); ?>" alt="Card image cap" >
              <div class="card-footer">
                  <h5 class="description"> <?php echo e($i++); ?>. <?php echo e($p->name); ?></h4>
              </div>
            </div>
          </div>
     </div>
