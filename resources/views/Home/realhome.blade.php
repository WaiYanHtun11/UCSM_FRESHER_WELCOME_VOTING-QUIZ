...
<!-- Navbar brand -->
<a class="navbar-brand " href="" style="color:black;"><img src="images/logo.png" class="logo-image"></a>
     ...
     <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                        <a href="Homeshop" style="text-decoration: none;color:black;">
                    <div class="card-body">
                      <div id="image">
                ...
                <div class="col-sm-12">
                        <a href="Homequiz" style="text-decoration: none;color:black;">
                    <div class="card-body">
                      <div id="image">
